...
//#include <rtt/ComponentLoader.hpp>
...
public:
    ...
    {
        this->ports()->addPort("Position",position).doc("1D Position of this plant.");
        this->ports()->addPort("Velocity",velocity).doc("1D Velocity of this plant.");
        this->ports()->addPort("Setpoints",setpoints).doc("1D drive setpoint of this plant.");
    }
